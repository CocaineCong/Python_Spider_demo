...
class IPProxyDownloadMiddleware(object):
    PROXY_URL='xxxxxx'    #这边就是写其中的代理ip


    def process_request(self, request, spider):  # 更换代理就是需要request请求去请求的
        if 'proxy' not in request.meta:
            pass

    def process_response(self, request, response, spider):  # 这边就是需要request的是否有响应
